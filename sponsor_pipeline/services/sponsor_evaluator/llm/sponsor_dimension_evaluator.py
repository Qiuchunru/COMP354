...
class ClaudeSponsorDimensionEvaluator(SponsorDimensionEvaluator):
    ...
    def evaluate_dimension(
        ...
        response = self._client.messages.create(
            ...
            messages=[{"role": "user", "content": _build_dimension_prompt(criterion, company, evidence)}],
            tools=[tool],
    ...
    def evaluate_summary(
        ...
        response = self._client.messages.create(
            ...
            messages=[{"role": "user", "content": _build_summary_prompt(company, evidence, criterion_scores)}],
            tools=[tool],
    ...
    def evaluate_dimension(
        ...
        response = self._client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user", "content": _build_dimension_prompt(criterion, company, evidence)},
            ],
    ...
    def evaluate_summary(
        ...
        response = self._client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user", "content": _build_summary_prompt(company, evidence, criterion_scores)},
            ],
            tools=[{
                "type": "function",
                "function": {
